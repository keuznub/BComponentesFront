            ...
            <div className="px-5 pb-5">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    <div className="flex items-center space-x-1 rtl:space-x-reverse">
                        {Array.from({ length: 5 }, (_, i) => <svg key={i} className={`w-4 h-4 ${(i+1>Math.round(product.rate))?"text-gray-300":"text-yellow-300"} hover:text-yellow-500 `} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">

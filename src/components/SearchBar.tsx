        ...
        <form onSubmit={handleOnSubmit} className={`fixed top-15 inset-x-0 z-10 max-w-lg mx-auto transition-all duration-500 ${isHided?"-translate-y-5 opacity-0 invisible":""}`}>
            <div className="flex">
                ...
                <div className="relative w-full">
                    <input type="search" id="search-dropdown" value={name} onChange={onChange} className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Ryzen 5 7600X, RX 7800XT..." required />

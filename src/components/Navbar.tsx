...
function Navbar() {
  ...
  const user = useAuth()
  const LinkClassName = 'text-sm rounded-sm dark:text-white text-black dark:hover:text-black hover:text-white transition-colors py-4 duration-100'

  return (


    <nav className="bg-orange-500 fixed w-full z-20 top-0 start-0 py-2 border-b border-gray-200 dark:border-gray-600 px-4">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="flex md:hidden md:order-1 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        <div className='order-0'>
          {user.isAuthenticated&&<UserDropdown />}
        </div>

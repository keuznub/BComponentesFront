...
function InputComponent({name,type,value,onChange,children, placeholder,required,className}:{name:string,type:HTMLInputTypeAttribute,value?:string|number,onChange?:(e:any)=>any,children?:ReactNode,placeholder?:string,required?:boolean,className?:string}) {
    return (
        <div className="mb-5">

      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6'>
        ...
        <div className='flex flex-col'>
          ...
          <div className="flex items-center">
            ...
            <p className="ms-2 text-sm font-bold text-gray-900 dark:text-white">{product?.rate}</p>
            <span className="w-1 h-1 mx-1.5 bg-gray-500 rounded-full dark:bg-gray-400"></span>
            <a href="" className="text-sm font-medium text-gray-900 underline hover:no-underline dark:text-white">{product?.opinions} reviews</a>
          </div>

  ...
  return (
    <form className="max-w-sm mx-auto min-w-sm p-4 border-1 rounded-2xl bg-zinc-50 dark:bg-zinc-900  mt-36" onSubmit={handleSubmit}>
      ...
      <div className="mb-5">
        ...
        <Link to={""} className='text-sm hover:text-blue-800 font-light italic'>Forgot password?</Link>
      </div>
      <div className="flex items-start mb-5">
        <div className="flex items-center h-5">
          <input id="remember" type="checkbox" value="" className="w-4 h-4 border border-gray-300 rounded-sm bg-gray-50 dark:bg-gray-700 dark:border-gray-600   " required />
        </div>
